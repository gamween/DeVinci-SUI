...
const features: { title: string; href: string; description: string }[] = [
  {
    title: "Live Streams",
    href: "/lives",
    description: "Watch and interact with live streaming content.",
  },
  {
    title: "Creator Dashboard",
    href: "/dashboard",
    description: "Manage your creator profile and exclusive content.",
  },
  {
    title: "Counter Demo",
    href: "/",
    description: "Try out the blockchain counter demo.",
  },
];
                  ...
                  <NavigationMenuLink asChild>
                    ...
                    >
                      ...
                      <p className="text-sm leading-tight text-slate-600">
                        Decentralized fan engagement platform built on Sui blockchain with IPFS streaming and Seal encryption.
                      </p>
                    </Link>
                  </NavigationMenuLink>
                </li>
